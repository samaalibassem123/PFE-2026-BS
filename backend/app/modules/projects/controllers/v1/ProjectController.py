...
@projects_router.get('/')
async def get_projects(db:DB_dependecy, limit: int = 50,offset: int = 0, name:str|None=None, year:int|None=None, month:int|None=None,user=Depends(get_current_user)):
